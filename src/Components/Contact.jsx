...
function Contact() {
  ...
  <div className="Contact"><img className="contact-img"src="./src/assets/email.png" alt="Email"></img>
      <a href="mailto:arunlokesh78@gmail.com">arunlokesh78@gmail.com</a>
   </div>

      <div className="Contact"> <img className="contact-img" src="./src/assets/phone.png" alt="Phone"></img>
      <a href="tel:+919019944841">+91 9019944841</a>
      </div>

     <div className="Contact">
      <img className="contact-img" src="./src/assets/linkedin.png" alt="Linkedin"></img>
      <a href="https://www.linkedin.com/in/arun-kumar-r-920841235" target="_blank">
        linkedin.com/in/arun-kumar-r
      </a></div>
  

    <div className="Contact"><img className="contact-img" src="./src/assets/github.png" alt="GitHub"></img>
